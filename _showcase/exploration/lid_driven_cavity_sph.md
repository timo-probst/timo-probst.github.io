...
---
<div>
  <video autoplay muted loop preload="none" class="w-100 rounded-xl-top" style="aspect-ratio: 1 / 1;" src="{{ '/assets/videos/lid_driven_cavity_dark.mp4' | relative_url }}"></video>
  <div class="card-body">
    <p class="card-text">
