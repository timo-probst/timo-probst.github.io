...
<video autoplay muted loop preload="none" class="w-100 rounded-xl-bottom" style="aspect-ratio: 960 / 374;" src="{{ '/assets/videos/karman_street_sph_grid.mp4' | relative_url }}"></video>
